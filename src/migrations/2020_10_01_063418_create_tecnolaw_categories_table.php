...
class CreateTecnolawCategoriesTable extends Migration
{
	/**
	 * Schema table name to migrate
	 * @var string
	 */
	public $tableName = 'tecnolaw_categories';
	...
	public function up()
	{
		Schema::create($this->tableName, function (Blueprint $table) {
			...
			$table->unsignedBigInteger('id_wp_woo')->nullable();
			...
			$table->index(['slug','name','id_wp_woo']);

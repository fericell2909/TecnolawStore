...
class CreateTecnolawShoppingCartsProductsTable extends Migration
{
	/**
	 * Schema table name to migrate
	 * @var string
	 */
	public $tableName = 'tecnolaw_shopping_carts_products';
	...
	public function up()
	{
		Schema::create($this->tableName, function (Blueprint $table) {
			...
			$table->foreign('cart_id', 'fk_cart_id_shopping_carts_idx')
				->references('id')->on('tecnolaw_shopping_carts')
				->onDelete('no action')
				->onUpdate('no action');
